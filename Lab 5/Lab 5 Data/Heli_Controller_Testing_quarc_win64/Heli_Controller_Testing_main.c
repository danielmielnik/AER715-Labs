...
typedef RT_MODEL_Heli_Controller_Test_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * Heli_Controller_Testing(void);

/* A global buffer for storing error messages (defined in quanser_common library) */
EXTERN char _rt_error_message[512];

/*
   extern void Heli_Controller_Testing_initialize();
   extern void Heli_Controller_Testing_terminate();
 */
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(Heli_Controller_Testing_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv,
    "shmem://Heli_Controller_Testing:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: Heli_Controller_Testing -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
   ...
   ************************/
  Heli_Controller_Testing_initialize();
  S = Heli_Controller_Testing_M;
  ...
  Heli_Controller_Testing_terminate();
